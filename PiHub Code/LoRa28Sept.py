...
from sqlite_functions28Sept import lora_sqlite, lora_my, query_mySQL
                ...
                if ID in self.node_list and (self.msg==0 or self.msg==1 or self.msg==2 or self.msg==3 or self.msg==5):
                    ...
                    if self.msg==0:
                        ...
                        if ID ==1:
                            ...
                            print 'Y:{} M:{} D:{} H:{} m:{} s:{}' .format(timeStamp[0], timeStamp[1], timeStamp[2], timeStamp[3], timeStamp[4], rec[7])
                            latit=((rec[8]>>4)*1000)
                            ...
                            print'longitude: {}{}' .format(longit, chr(rec[18]))
                            size=len(rec)
                            ...
                            print'Local: Rssi: {} Snr: {}' .format(PyLora.packet_rssi(), PyLora.packet_snr())
