...
from sqlite_functionsOct11 import lora_sqlite, query_mySQL
import csv, os, threading
from LoRaOct11 import piLora
...
def setup():
    ...
    if request.method == 'POST':
        ...
        elif request.form['action'] == 'enable/disable':
            if(not test.field):
                test.field=True
                print'Field Test starting'
            else:
                test.field=False
                print'Field Test stopping...'            
    else:
        pass
    return render_template('setup.html', field=test.field)
